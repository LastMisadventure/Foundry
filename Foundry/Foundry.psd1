...
@{
    ...
    'Open-Project', 'Publish-Project', 'Remove-Project',
    'Set-ProjectModuleVersion', 'Test-ProjectReadyForRelease',
    'Update-ProjectModuleManifest', 'Update-ProjectVsCodeFileSet',
    'Update-PsModulePath'
