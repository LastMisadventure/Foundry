...
RequiredModules = @(@{ModuleName = 'Posh-Git'; GUID = '74c9fd30-734b-4c89-a8ae-7727ad21d1d5'; RequiredVersion = '0.7.3'; })
...
FunctionsToExport = 'Get-Project', 'Get-PsModulePath', 'Get-RandomReleaseName', 
               'Import-ProjectModule', 'Invoke-CodeAnalyzer', 'Invoke-TestSuite', 
               'Move-ProjectToArchive', 'New-MagicQuadrant', 'New-Project', 
               'New-ProjectBranch', 'New-ProjectEstimate', 'Open-Project', 
               'Publish-Project', 'Remove-Project', 'Set-ProjectModuleVersion', 
